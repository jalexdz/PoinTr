...
from pointr.datasets.io import IO

from pointr.tools import builder
from pointr.utils.config import cfg_from_yaml_file
from pointr.tools.predictor import AdaPoinTrPredictor
...
def test_adapointr_inference_smoke():
    ...
    out_pcd.colors =  o3d.utility.Vector3dVector(np.tile([0.0, 1.0, 0.0], (complete.shape[0], 1)))
